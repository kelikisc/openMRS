...
WebUI.verifyElementPresent(findTestObject('Page_Login/Error_Location'), 0)

WebUI.verifyElementText(findTestObject('Page_Login/Error_Location'), 'You must choose a location!')
